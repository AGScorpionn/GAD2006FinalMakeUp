...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNetGameInstance_Host_Statics::NewProp_PlayerInfo = { "PlayerInfo", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NetGameInstance_eventHost_Parms, PlayerInfo), Z_Construct_UScriptStruct_FSPlayerInfo, METADATA_PARAMS(0, nullptr) }; // 4010385190
...
struct Z_Construct_UClass_UNetGameInstance_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UNetGameInstance_Host, "Host" }, // 1820709596
		{ &Z_Construct_UFunction_UNetGameInstance_Join, "Join" }, // 350610116
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNetGameInstance_Statics::NewProp_PlayerInfo = { "PlayerInfo", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UNetGameInstance, PlayerInfo), Z_Construct_UScriptStruct_FSPlayerInfo, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PlayerInfo_MetaData), NewProp_PlayerInfo_MetaData) }; // 4010385190
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_APK_GAD2006_aslan_GAD2006_master_Labwork4_Source_LabWork4_Private_NetGameInstance_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNetGameInstance, UNetGameInstance::StaticClass, TEXT("UNetGameInstance"), &Z_Registration_Info_UClass_UNetGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetGameInstance), 3979911085U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_APK_GAD2006_aslan_GAD2006_master_Labwork4_Source_LabWork4_Private_NetGameInstance_h_2643915931(TEXT("/Script/LabWork4"),
	Z_CompiledInDeferFile_FID_APK_GAD2006_aslan_GAD2006_master_Labwork4_Source_LabWork4_Private_NetGameInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_APK_GAD2006_aslan_GAD2006_master_Labwork4_Source_LabWork4_Private_NetGameInstance_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
